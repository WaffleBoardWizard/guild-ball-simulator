...
var gamePieces = [];
        ...
        function init() {
            ...
            for (i = 0; i < numberOfPieces; i++) { 
                  ...
                  gamePieceGraphic.graphics.beginFill("DeepSkyBlue").drawCircle(0, 0, 10);
        ...
        function releaseDragNode(evt) {
            getGamePieceForEvent(evt, function(gamePiece) {
                        ...
                        gamePiece.movement.overlays.push({ type: CONSTANTS.NODE_OVERLAY, value: nodeLine});
                        ...
                        getRangeUsed(gamePiece,evt, function(rangeUsed) {
                              ...
                              gamePiece.movement.nodes.push({ x: evt.currentTarget.x, y: evt.currentTarget.y, rangeUsed: rangeUsed })
                        ...
                        if(gamePiece.movement.status == CONSTANTS.MOVEMENT_MOVEABLE || gamePiece.movement.status == CONSTANTS.MOVEMENT_NODE_MOVEABLE) {
                              ...
                              if(gamePiece.movement.status == CONSTANTS.MOVEMENT_NODE_MOVEABLE) {
                                   ...
                                   y = gamePiece.movement.lastNode.y; 
                                    ...
                                    gamePiece.movement.lastNode = { x: x, y: y, rangeUsed: 0};
                                    ...
                                    maxRange.y = y;
                                    maxRange.alpha = 0.2;
                                    gamePiece.movement.overlays.push({ type: CONSTANTS.MAX_RANGE_OVERLAY, value: maxRange });
                              ...
                              origin.x = x;
                              origin.y = y;
                              gamePiece.movement.overlays.push({ type: CONSTANTS.NODE_OVERLAY, value: origin });
                        ...
                        getRangeUsed(gamePiece,evt, function(rangeUsed) {
                              ...
                              if((gamePiece.movement.range - rangeUsed) > 0) {
                                    ...
                                    detectCollision(evt,gamePieces,function(collision) {
                                          ...
                                          gamePiece.movement.overlays.push({ type: CONSTANTS.RANGE_OVERLAY, value: range });
